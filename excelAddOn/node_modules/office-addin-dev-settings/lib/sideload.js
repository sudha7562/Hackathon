        ...
        try {
            ...
            if (manifestPath.endsWith(".json")) {
                if (isDotnetInstalled()) {
                    ...
                    manifestPath = yield convertJsonToXmlManifest(manifestPath);
                }
                else {
                    throw new office_addin_usage_data_1.ExpectedError(".Net 5 or greater is required for json manifests.");
                }
            }
...
function convertJsonToXmlManifest(manifestPath) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        return new Promise((resolve, reject) => {
            if (manifestPath.endsWith(".json") && fs.existsSync(manifestPath)) {
                ...
                const newManifestPath = path.join(process.env.TEMP, "manifest.xml");
...
function stripBom(manifestPath) {
    try {
