...
const utils_2 = require("../component/resource/appManifest/utils");
...
class FxCore {
    ...
    async executeUserTaskV3(func, inputs, ctx) {
        ...
        if (func.method === "addCICDWorkflows") {
            ...
            const path = await utils_2.getTeamsAppManifestPath(inputs.projectPath);
    ...
    async getQuestionsForUserTask(func, inputs, ctx) {
        ...
        if (globalVars_1.isV3()) {
            ...
            if (func.method === "addFeature") {
                ...
                const apiConnectorImpl = new plugin_1.ApiConnectorImpl();
    ...
    async _init(inputs, ctx, isInitExistingApp = false) {
        ...
        await fs.ensureDir(path.join(projectPath, `.${teamsfx_api_1.ConfigFolderName}`));
        await fs.ensureDir(path.join(await utils_3.getProjectTemplatesFolderPath(projectPath), `${teamsfx_api_1.AppPackageFolderName}`));
