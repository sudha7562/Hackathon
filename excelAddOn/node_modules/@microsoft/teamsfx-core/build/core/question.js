...
function createAppNameQuestion(validateProjectPathExistence = true) {
    const question = {
        type: "text",
...
exports.ProgrammingLanguageQuestion = {
    ...
    dynamicOptions: (inputs) => {
        ...
        if (capabilities && capabilities.includes && capabilities.includes(question_1.TabSPFxItem.id))
    ...
    default: (inputs) => {
        if (featureFlags_1.isPreviewFeaturesEnabled()) {
            ...
            if (capability && capability === question_1.TabSPFxItem.id) {
                return "typescript";
            }
            const feature = inputs[CoreQuestionNames.Features];
            if (feature && feature === question_1.TabSPFxItem.id) {
                return "typescript";
            }
        }
        else {
...
function createCapabilityQuestion() {
    ...
    if (featureFlags_1.isBotNotificationEnabled()) {
        ...
        staticOptions = [
            ...[question_1.CommandAndResponseOptionItem, question_1.NotificationOptionItem],
            ...(tools_1.isExistingTabAppEnabled() ? [question_1.ExistingTabOptionItem] : []),
            ...(tools_1.isAadManifestEnabled() ? [question_1.TabNonSsoItem] : []),
            ...[question_1.TabNewUIOptionItem, question_1.TabSPFxNewUIItem, question_1.MessageExtensionNewUIItem],
            ...(tools_1.isM365AppEnabled() ? [question_1.M365SsoLaunchPageOptionItem, question_1.M365SearchAppOptionItem] : []),
        ];
    }
    else {
        staticOptions = [
            ...[question_1.TabOptionItem, question_1.BotOptionItem, question_1.MessageExtensionItem, question_1.TabSPFxItem],
            ...(tools_1.isAadManifestEnabled() ? [question_1.TabNonSsoItem] : []),
            ...(tools_1.isExistingTabAppEnabled() ? [question_1.ExistingTabOptionItem] : []),
            ...(tools_1.isM365AppEnabled() ? [question_1.M365SsoLaunchPageOptionItem, question_1.M365SearchAppOptionItem] : []),
        ];
    ...
    return {
        ...
        default: featureFlags_1.isBotNotificationEnabled() ? [question_1.CommandAndResponseOptionItem.id] : [question_1.TabOptionItem.id],
...
function createCapabilityForDotNet() {
    const staticOptions = [
        question_1.NotificationOptionItem,
        question_1.CommandAndResponseOptionItem,
        question_1.TabOptionItem,
        question_1.MessageExtensionItem,
    ];
    return {
        name: CoreQuestionNames.Capabilities,
...
function createCapabilityQuestionPreview() {
    // new capabilities question order
    const staticOptions = [
        question_1.NotificationOptionItem,
        question_1.CommandAndResponseOptionItem,
        question_1.TabNewUIOptionItem,
        question_1.TabSPFxNewUIItem,
        question_1.TabNonSsoItem,
        question_1.BotNewUIOptionItem,
        question_1.MessageExtensionNewUIItem,
        question_1.M365SsoLaunchPageOptionItem,
        question_1.M365SearchAppOptionItem,
    ];
    if (tools_1.isExistingTabAppEnabled()) {
        staticOptions.splice(2, 0, question_1.ExistingTabOptionItem);
    }
    return {
        name: CoreQuestionNames.Capabilities,
...
function validateCapabilities(inputs) {
    ...
    let result = validateConflict([
        new Set([question_1.BotOptionItem.id, question_1.MessageExtensionItem.id]),
        new Set([question_1.NotificationOptionItem.id]),
        new Set([question_1.CommandAndResponseOptionItem.id]),
    ], set);
    if (result)
        return result;
    result = validateConflict([
        ...
        new Set([question_1.TabSPFxItem.id]),
    ], set);
    if (result)
        return result;
    result = validateConflict([new Set([question_1.TabOptionItem.id]), new Set([question_1.TabNonSsoItem.id])], set);
    if (result)
        return result;
    result = validateConflict([
        new Set([
            ...
            question_1.NotificationOptionItem.id,
            question_1.CommandAndResponseOptionItem.id,
            question_1.ExistingTabOptionItem.id,
        ]),
        new Set([question_1.M365SsoLaunchPageOptionItem.id]),
        new Set([question_1.M365SearchAppOptionItem.id]),
    ], set);
    return result;
}
...
async function onChangeSelectionForCapabilities(currentSelectedIds, previousSelectedIds) {
    ...
    result = handleSelectionConflict([
        ...
        new Set([question_1.TabSPFxItem.id]),
        new Set([question_1.ExistingTabOptionItem.id]),
        new Set([question_1.M365SsoLaunchPageOptionItem.id]),
        new Set([question_1.M365SearchAppOptionItem.id]),
    ], previousSelectedIds, result);
    result = handleSelectionConflict([new Set([question_1.TabOptionItem.id]), new Set([question_1.TabNonSsoItem.id])], previousSelectedIds, result);
    return result;
}
...
function newResourceGroupNameQuestion(rmClient) {
    ...
    question.validation = {
        validFunc: async (input) => {
            ...
            const maybeExist = await ResourceGroupHelper_1.resourceGroupHelper.checkResourceGroupExistence(name, rmClient);
            if (maybeExist.isErr()) {
