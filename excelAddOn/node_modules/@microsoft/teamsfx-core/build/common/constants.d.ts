...
export declare class Bicep {
    static readonly ParameterOrchestrationFileName: string;
    static readonly ModuleOrchestrationFileName: string;
    static readonly OutputOrchestrationFileName: string;
    static readonly VariablesOrchestrationFileName: string;
    static readonly ParameterFileName: string;
    static readonly ProvisionFileName: string;
...
export declare class ResourcePlugins {
...
export declare class PluginDisplayName {
...
export declare class ManifestVariables {
