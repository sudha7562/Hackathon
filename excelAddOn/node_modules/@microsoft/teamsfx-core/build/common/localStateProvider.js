...
class LocalStateProvider {
    ...
    async loadV2(cryptoProvider, includeAAD) {
        if (await fs.pathExists(this.projectPath)) {
            const envDataResult = await environment_1.environmentManager.loadEnvInfo(this.projectPath, cryptoProvider, environment_1.environmentManager.getLocalEnvName(), globalVars_1.isV3());
