...
const aadComponentKey = globalVars_1.isV3() ? constants_3.ComponentNames.AadApp : constants_2.BuiltInFeaturePluginNames.aad;
const tabComponentKey = globalVars_1.isV3() ? constants_3.ComponentNames.TeamsTab : constants_2.BuiltInFeaturePluginNames.frontend;
const botComponentKey = globalVars_1.isV3() ? constants_3.ComponentNames.TeamsBot : constants_2.BuiltInFeaturePluginNames.bot;
class Utils {
    ...
    static async getCurrentTenantId(m365TokenProvider) {
        var _a;
        const tokenObjectRes = await (m365TokenProvider === null || m365TokenProvider === void 0 ? void 0 : m365TokenProvider.getJsonObject({ scopes: common_1.GraphScopes }));
...
class SetApplicationInContextConfig {
    ...
    restoreConfigFromContext(ctx) {
        ...
        if (common_1.isAadManifestEnabled()) {
            const botEndpoint = (_c = ctx.envInfo.state
                .get(constants_1.Plugins.teamsBot)) === null || _c === void 0 ? void 0 : _c.get(constants_1.ConfigKeysOfOtherPlugin.teamsBotEndpoint);
            if (botEndpoint) {
