...
let SqlPlugin = class SqlPlugin {
    ...
    async updateArmTemplates(ctx) {
        return this.runWithSqlError(constants_1.Telemetry.stage.updateArmTemplates, () => this.sqlImpl.updateArmTemplates(ctx), ctx);
    }
    async generateArmTemplates(ctx) {
        var _a, _b;
        let handleFunction;
        if ((_b = (_a = ctx.answers) === null || _a === void 0 ? void 0 : _a.existingResources) === null || _b === void 0 ? void 0 : _b.includes(constants_1.Constants.pluginFullName)) {
            handleFunction = this.sqlImpl.generateNewDatabaseBicepSnippet;
        }
        else {
            handleFunction = this.sqlImpl.generateArmTemplates;
        }
        return this.runWithSqlError(constants_1.Telemetry.stage.generateArmTemplates, () => handleFunction(ctx), ctx);
    }
