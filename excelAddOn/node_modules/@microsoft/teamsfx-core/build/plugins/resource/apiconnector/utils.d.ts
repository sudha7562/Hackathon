...
export declare class Notification {
    ...
    static GetBasicString(apiName: string, components: string[], languageType: string): string;
    static GetLinkNotification(): string;
    static getNotificationMsg(config: ApiConnectorConfiguration, languageType: string): string;
}
