...
exports.Notification = exports.concatLines = exports.checkInputEmpty = exports.sendErrorTelemetry = exports.removeFileIfExist = exports.copyFileIfExist = exports.getSampleFileName = exports.generateTempFolder = void 0;
...
class Notification {
    static GetBasicString(apiName, components, languageType) {
        const fileName = getSampleFileName(apiName, languageType);
        const generatedFiles = concatLines(components.map((item) => path_1.default.join(item, fileName)), " and ");
    ...
    static getNotificationMsg(config, languageType) {
        const apiName = config.APIName;
        const retMsg = Notification.GetBasicString(apiName, config.ComponentType, languageType);
        return retMsg;
    }
}
