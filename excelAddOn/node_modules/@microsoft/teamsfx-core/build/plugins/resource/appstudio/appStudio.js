...
(function (AppStudioClient) {
    ...
    async function getApp(teamsAppId, appStudioToken, logProvider) {
        const requester = createRequesterWithToken(appStudioToken);
        try {
            const response = await utils_1.RetryHandler.Retry(() => requester.get(`/api/appdefinitions/${teamsAppId}`));
            if (response && response.data) {
                const app = response.data;
        ...
        try {
            ...
            if (response && response.data) {
                ...
                if (response.data.error) {
                    ...
                    throw results_1.AppStudioResultFactory.SystemError(errors_1.AppStudioError.TeamsAppPublishFailedError.name, errors_1.AppStudioError.TeamsAppPublishFailedError.message(teamsAppId, requestPath), `code: ${response.data.error.code}, message: ${response.data.error.message}`);
                }
                else {
            ...
            if (e instanceof teamsfx_api_1.SystemError) {
                ...
                const correlationId = (_c = e.response) === null || _c === void 0 ? void 0 : _c.headers[constants_1.Constants.CORRELATION_ID];
                const requestPath = `${(_e = (_d = e.response) === null || _d === void 0 ? void 0 : _d.request) === null || _e === void 0 ? void 0 : _e.method} ${(_f = e.response.request) === null || _f === void 0 ? void 0 : _f.path}`;
                throw results_1.AppStudioResultFactory.SystemError(errors_1.AppStudioError.TeamsAppPublishFailedError.name, errors_1.AppStudioError.TeamsAppPublishFailedError.message(teamsAppId, requestPath, correlationId), e);
            }
        }
    }
        ...
        try {
            ...
            if (response && response.data) {
                if (response.data.error || response.data.errorMessage) {
                    throw results_1.AppStudioResultFactory.SystemError(errors_1.AppStudioError.TeamsAppPublishFailedError.name, errors_1.AppStudioError.TeamsAppPublishFailedError.message(teamsAppId, requestPath), ((_c = response.data.error) === null || _c === void 0 ? void 0 : _c.message) || response.data.errorMessage);
                }
                else {
            ...
            if (error instanceof teamsfx_api_1.SystemError) {
                ...
                const correlationId = (_d = error.response) === null || _d === void 0 ? void 0 : _d.headers[constants_1.Constants.CORRELATION_ID];
                const requestPath = `${(_f = (_e = error.response) === null || _e === void 0 ? void 0 : _e.request) === null || _f === void 0 ? void 0 : _f.method} ${(_g = error.response.request) === null || _g === void 0 ? void 0 : _g.path}`;
                throw results_1.AppStudioResultFactory.SystemError(errors_1.AppStudioError.TeamsAppPublishFailedError.name, errors_1.AppStudioError.TeamsAppPublishFailedError.message(teamsAppId, requestPath, correlationId), error);
            }
        }
    }
    ...
    async function grantPermission(teamsAppId, appStudioToken, newUser) {
        ...
        try {
            ...
            if (((_c = err === null || err === void 0 ? void 0 : err.message) === null || _c === void 0 ? void 0 : _c.indexOf("Request failed with status code 400")) >= 0) {
