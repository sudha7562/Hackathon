...
export declare function createBotAAD(ctx: ResourceContextV3): Promise<Result<any, FxError>>;
export declare function createBotRegInAppStudio(botConfig: any, ctx: ResourceContextV3): Promise<Result<undefined, FxError>>;
export declare function commonTelemetryPropsForBot(context: ContextV3): Record<string, string>;
