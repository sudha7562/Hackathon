import { FxError, InputsWithProjectPath, M365TokenProvider, Result, ResourceContextV3, TeamsAppManifest, TokenProvider, v2, v3 } from "@microsoft/teamsfx-api";
/**
 ...
 */
export declare function buildTeamsAppPackage(projectPath: string, envInfo: v3.EnvInfoV3, withEmptyCapabilities?: boolean, telemetryProps?: Record<string, string>): Promise<Result<string, FxError>>;
/**
 * Validate manifest
...
export declare function getManifest(projectPath: string, envInfo: v3.EnvInfoV3, telemetryProps?: Record<string, string>): Promise<Result<TeamsAppManifest, FxError>>;
