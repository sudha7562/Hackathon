...
exports.commonTelemetryPropsForBot = exports.createBotRegInAppStudio = exports.createBotAAD = exports.BotService = void 0;
...
let BotService = class BotService extends azureResource_1.AzureResource {
    ...
    async provision(context, inputs, actionContext) {
        ...
        if (actionContext === null || actionContext === void 0 ? void 0 : actionContext.telemetryProps) {
            lodash_1.merge(actionContext.telemetryProps, commonTelemetryPropsForBot(context));
        }
    ...
    async configure(context, inputs, actionContext) {
        ...
        if (context.envInfo.envName === "local") {
            ...
            await appStudio_1.AppStudio.updateMessageEndpoint(appStudioToken, teamsBotState.botId, `${teamsBotState.endpoint}${strings_1.CommonStrings.MESSAGE_ENDPOINT_SUFFIX}`);
        }
        return teamsfx_api_1.ok(undefined);
    }
};
...
function commonTelemetryPropsForBot(context) {
    const teamsBot = workflow_1.getComponent(context.projectSetting, constants_2.ComponentNames.TeamsBot);
    const props = {
        [constants_1.TelemetryKeys.HostType]: (teamsBot === null || teamsBot === void 0 ? void 0 : teamsBot.hosting) === constants_2.ComponentNames.Function ? "azure-function" : "app-service",
        [constants_1.TelemetryKeys.BotCapabilities]: (teamsBot === null || teamsBot === void 0 ? void 0 : teamsBot.capabilities)
            ? JSON.stringify(teamsBot.capabilities)
            : "",
    };
    return props;
}
exports.commonTelemetryPropsForBot = commonTelemetryPropsForBot;
