import { Bicep, CallServiceEffect, Component, ConfigurationBicep, ContextV3, FileEffect, FxError, Inputs, InputsWithProjectPath, Json, ProjectSettingsV3, ProvisionBicep, Result, UserInteraction, v3 } from "@microsoft/teamsfx-api";
...
export declare function isHostedByAzure(context: ContextV3): boolean;
