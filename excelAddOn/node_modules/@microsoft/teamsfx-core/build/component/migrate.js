...
exports.APIM_STATE_KEY = globalVars_1.isV3() ? constants_2.ComponentNames.APIM : constants_1.BuiltInFeaturePluginNames.apim;
exports.API_STATE_KEY = globalVars_1.isV3() ? constants_2.ComponentNames.TeamsApi : constants_1.BuiltInFeaturePluginNames.function;
exports.AAD_STATE_KEY = globalVars_1.isV3() ? constants_2.ComponentNames.AadApp : constants_1.BuiltInFeaturePluginNames.aad;
exports.TAB_STATE_KEY = globalVars_1.isV3() ? constants_2.ComponentNames.TeamsTab : constants_1.BuiltInFeaturePluginNames.frontend;
exports.BOT_STATE_KEY = globalVars_1.isV3() ? constants_2.ComponentNames.TeamsBot : constants_1.BuiltInFeaturePluginNames.bot;
exports.SIMPLE_AUTH_STATE_KEY = globalVars_1.isV3()
    ? constants_2.ComponentNames.SimpleAuth
    : constants_1.BuiltInFeaturePluginNames.simpleAuth;
exports.APP_MANIFEST_KEY = globalVars_1.isV3()
...
function convertProjectSettingsV2ToV3(settingsV2) {
    var _a, _b, _c, _d;
    ...
    if (solutionSettings && (!settingsV3.components || settingsV3.components.length === 0)) {
        ...
        if (solutionSettings.activeResourcePlugins.includes("fx-resource-bot")) {
            ...
            if (solutionSettings.capabilities.includes(question_1.MessageExtensionNewUIItem.id) &&
...
function convertProjectSettingsV3ToV2(settingsV3) {
    ...
    if (((_a = settingsV3.components) === null || _a === void 0 ? void 0 : _a.length) > 0) {
        ...
        if (teamsBot) {
            ...
            if ((botCapabilities === null || botCapabilities === void 0 ? void 0 : botCapabilities.includes("bot")) ||
                (botCapabilities === null || botCapabilities === void 0 ? void 0 : botCapabilities.includes("notification")) ||
            ...
            if ((botCapabilities === null || botCapabilities === void 0 ? void 0 : botCapabilities.includes("message-extension")) &&
                !settingsV2.solutionSettings.capabilities.includes(question_1.MessageExtensionNewUIItem.id)) {
                settingsV2.solutionSettings.capabilities.push(question_1.MessageExtensionNewUIItem.id);
            }
