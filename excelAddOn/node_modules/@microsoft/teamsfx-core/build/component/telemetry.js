...
function getCommonProperties() {
    const props = {
        [constants_3.TelemetryConstants.properties.appId]: globalVars_1.globalVars.teamsAppId,
        [constants_3.TelemetryConstants.properties.tenantId]: globalVars_1.globalVars.m365TenantId,
    };
    return props;
}
...
function sendSuccessEvent(eventName, properties, measurements) {
    var _a;
    const props = Object.assign(Object.assign(Object.assign({}, getCommonProperties()), properties), { [constants_3.TelemetryConstants.properties.success]: constants_3.TelemetryConstants.values.yes });
...
function sendErrorEvent(eventName, error, properties, measurements) {
    ...
    const errorType = error instanceof teamsfx_api_1.SystemError
        ? constants_3.TelemetryConstants.values.systemError
        : constants_3.TelemetryConstants.values.userError;
    const props = Object.assign(Object.assign(Object.assign({}, getCommonProperties()), properties), { [constants_3.TelemetryConstants.properties.success]: constants_3.TelemetryConstants.values.no, [constants_3.TelemetryConstants.properties.errorCode]: errorCode, [constants_3.TelemetryConstants.properties.errorType]: errorType, [constants_3.TelemetryConstants.properties.errorMessage]: error.message });
    (_a = globalVars_1.TOOLS.telemetryReporter) === null || _a === void 0 ? void 0 : _a.sendTelemetryErrorEvent(eventName, props, measurements !== null && measurements !== void 0 ? measurements : {}, [
        constants_3.TelemetryConstants.properties.errorMessage,
    ]);
}
...
function sendMigratedSuccessEvent(eventName, context, inputs, properties, measurements) {
    ...
    if (eventName === telemetry_1.TelemetryEvent.AddFeature) {
        ...
        if (componentName === constants_3.ComponentNames.TeamsBot) {
            props = fulfillCommonBotProperties(props, context.projectSetting.components.find((component) => component.name === constants_3.ComponentNames.TeamsBot));
        }
...
function sendMigratedErrorEvent(eventName, error, context, inputs, properties, measurements) {
    ...
    switch (error.source) {
        case "Storage":
            componentName = constants_2.PluginNames.FE;
            break;
        case "WebApp":
            componentName = (inputs === null || inputs === void 0 ? void 0 : inputs["Scenario"]) === constants_3.Scenarios.Tab ? constants_2.PluginNames.FE : constants_2.PluginNames.BOT;
            break;
        case "Functions":
            componentName = (inputs === null || inputs === void 0 ? void 0 : inputs["Scenario"]) === constants_3.Scenarios.Api ? constants_2.PluginNames.FUNC : constants_2.PluginNames.BOT;
            break;
        case "BotService":
            componentName = constants_2.PluginNames.BOT;
            break;
    }
    if (componentName) {
        const props = Object.assign(Object.assign({}, properties), { [telemetry_1.TelemetryProperty.Component]: componentName });
...
function needMigrate(eventName, properties) {
    ...
    return ([constants_3.ComponentNames.TeamsApi, constants_3.ComponentNames.TeamsBot, constants_3.ComponentNames.TeamsTab].includes(component) ||
        (component === "core" &&
...
function getMigrateComponents(context) {
    return context.projectSetting.components.filter((component) => [constants_3.ComponentNames.TeamsApi, constants_3.ComponentNames.TeamsBot, constants_3.ComponentNames.TeamsTab].includes(component.name));
}
function migrateComponentName(componentName) {
    switch (componentName) {
        case constants_3.ComponentNames.TeamsApi:
            return constants_2.PluginNames.FUNC;
        case constants_3.ComponentNames.TeamsBot:
            return constants_2.PluginNames.BOT;
        case constants_3.ComponentNames.TeamsTab:
            return constants_2.PluginNames.FE;
        default:
            return componentName;
    }
}
function migrateDeploy(cb, context, inputs, properties) {
    let inputPlugins = inputs[question_1.AzureSolutionQuestionNames.PluginSelectionDeploy];
    ...
    if (Array.isArray(inputPlugins)) {
        inputPlugins.forEach((pluginName) => {
            ...
            if (pluginName === constants_2.PluginNames.BOT) {
                props = fulfillCommonBotProperties(props, context.projectSetting.components.find((component) => component.name === constants_3.ComponentNames.TeamsBot));
            }
            cb(props);
        });
...
function fulfillCommonBotProperties(props, component) {
    if ((component === null || component === void 0 ? void 0 : component.name) === constants_3.ComponentNames.TeamsBot) {
        props = Object.assign(Object.assign({}, props), { [constants_1.TelemetryKeys.HostType]: (component === null || component === void 0 ? void 0 : component.hosting) === constants_3.ComponentNames.Function ? "azure-function" : "app-service", [constants_1.TelemetryKeys.BotCapabilities]: (component === null || component === void 0 ? void 0 : component.capabilities)
