...
const answer_1 = require("../../plugins/resource/apim/answer");
const config_1 = require("../../plugins/resource/apim/config");
const constants_1 = require("../../plugins/resource/apim/constants");
const factory_1 = require("../../plugins/resource/apim/factory");
...
let ApimFeature = class ApimFeature {
    ...
    async add(context, inputs) {
        ...
        if (!hasFunc) {
            const teamsApi = typedi_1.default.get(constants_2.ComponentNames.TeamsApi);
            const res = await teamsApi.add(context, inputs);
            if (res.isErr())
                return teamsfx_api_1.err(res.error);
            effects.push("add teams-api");
            addedResources.push(plugins_1.AzureResourceFunction.id);
        }
        // 2. scaffold
        {
        ...
        {
            const apimResource = typedi_1.default.get(constants_2.ComponentNames.APIM);
        ...
        addedResources.push(plugins_1.AzureResourceApim.id);
    ...
    async generateCode(context, inputs, actionContext) {
        ...
        if (answer.validate) {
            await answer.validate(constants_1.PluginLifeCycle.Scaffold, apimConfig, inputs.projectPath);
        }
        answer.save(constants_1.PluginLifeCycle.Scaffold, apimConfig);
        await ((_a = actionContext === null || actionContext === void 0 ? void 0 : actionContext.progressBar) === null || _a === void 0 ? void 0 : _a.next(constants_1.ProgressMessages[constants_1.ProgressStep.Scaffold].Scaffold));
...
tslib_1.__decorate([
    lib_1.hooks([
        actionExecutionMW_1.ActionExecutionMW({
            ...
            progressTitle: constants_1.ProgressStep.Scaffold,
            progressSteps: Object.keys(constants_1.ProgressMessages[constants_1.ProgressStep.Scaffold]).length,
        }),
    ]),
