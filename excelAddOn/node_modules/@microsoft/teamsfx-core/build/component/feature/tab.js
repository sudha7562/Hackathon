...
const tabCode_1 = require("../code/tabCode");
...
let TeamsTab = class TeamsTab {
    ...
    async add(context, inputs, actionContext) {
        ...
        const clonedInputs = lodash_1.cloneDeep(inputs);
        clonedInputs.folder || (clonedInputs.folder = inputs[question_1.CoreQuestionNames.ProgrammingLanguage] === "csharp"
            ? "."
        ...
        tabConfig = {
            ...
            deploy: true,
            provision: inputs[question_1.CoreQuestionNames.ProgrammingLanguage] != "csharp",
            build: true,
        ...
        if (bicepRes.isErr())
            return bicepRes;
        // 2.3 add sso
        if (inputs[question_2.AzureSolutionQuestionNames.Features] !== question_2.TabNonSsoItem.id) {
        ...
        // 5. app-manifest.addCapability
        {
            ...
            const clonedInputs = Object.assign(Object.assign({}, lodash_1.cloneDeep(inputs)), { validDomain: "{{state.fx-resource-frontend-hosting.domain}}" });
            const manifestComponent = typedi_1.Container.get(constants_2.ComponentNames.AppManifest);
            const res = await manifestComponent.addCapability(clonedInputs, capabilities);
            if (res.isErr())
                return teamsfx_api_1.err(res.error);
    ...
    async provision(context, inputs) {
        if (context.envInfo.envName === "local") {
            context.envInfo.state[constants_2.ComponentNames.TeamsTab] =
                context.envInfo.state[constants_2.ComponentNames.TeamsTab] || {};
            context.envInfo.state[constants_2.ComponentNames.TeamsTab][constants_3.FRONTEND_INDEX_PATH] =
                constants_1.Constants.FrontendIndexPath;
        }
        return teamsfx_api_1.ok(undefined);
    }
...
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:paramtypes", [Object, Object]),
    tslib_1.__metadata("design:returntype", Promise)
], TeamsTab.prototype, "configure", null);
tslib_1.__decorate([
    lib_1.hooks([
        actionExecutionMW_1.ActionExecutionMW({
            errorSource: "FE",
